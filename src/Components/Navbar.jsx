        ...
        <div className="container flex justify-between items-center">
          <div>
            <a href="#" className="font-bold text-2xl sm:text-3xl flex gap-2">
              <img src={handbag} alt="handbag" className="w-10 uppercase" />
              Shopsy
            </a>
          </div>
          ...
          <button
            ...
            className="bg-orange-500 hover:bg-orange-500 transition-all duration-200 text-white py-1 px-4 rounded-full flex items-center gap-3 group"
          >
      ...
      <div className="flex justify-center">
        <ul className="sm:flex hidden items-center gap-4">
          ...
          <li className="group relative cursor-pointer">
            ...
            <div className="absolute z-[99999] hidden group-hover:block w-[150px] rounded-md bg-white p-2 text-black">
              <ul>
